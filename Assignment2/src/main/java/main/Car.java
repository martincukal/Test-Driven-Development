...
public class Car implements CarInterface {
	...
	public void moveForward() throws StreetLengthException {
		if (this.getPositionX() < 100 && this.getPositionX()>= 0) {
	...
	public boolean leftLaneDetect(USoundInterface r1, USoundInterface r2, USoundInterface r3, LidarInterface l1) {
	...
	public void changeLane(USoundInterface r1, USoundInterface r2, USoundInterface r3, LidarInterface l1)
